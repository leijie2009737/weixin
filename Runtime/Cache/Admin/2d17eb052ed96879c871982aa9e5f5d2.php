...
<body>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo U('Wuye/add');?>">新 增</a>
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wuye): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["uid"]); ?>" /></td>
                        <td><?php echo ($wuye["sn"]); ?> </td>
                        <td><?php echo ($wuye["name"]); ?></td>
                        <td><?php echo ($wuye["tel"]); ?></td>
                        <td><?php echo ($wuye["address"]); ?></td>
                        <td><?php echo ($wuye["question"]); ?></td>
                        <td><span><?php echo (time_format($vo["create_time"])); ?></span></td>
                        <!--<td><?php echo ($vo["status_text"]); ?></td>-->
                        <td><?php echo (show_status_op($vo["status"])); ?></td>
